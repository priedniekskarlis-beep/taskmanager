...
```bash
docker compose -f 1-6_docker-compose.yml ps
```

## View Logs

```bash
docker compose -f 1-6_docker-compose.yml logs -f
```
...
```bash
docker compose -f 1-6_docker-compose.yml down -v
docker compose -f 1-6_docker-compose.yml up -d --build
```
