# 1-6 - Uzdevumu pārvaldības aplikācija / Task Management Application

## Project Purpose

Create a Kanban-style application with tasks, statuses, priorities, due dates, and simple user assignment.
